...
from synergyml.llm.gpt.completion import get_chat_completion
from synergyml.llm.gpt.embedding import get_embedding
...
from synergyml.llm.gpt.clients.openai.tuning import (
    create_tuning_job,
    await_results,
    delete_file,
)
import uuid
from synergyml.llm.gpt.clients.openai.credentials import (
    set_credentials as _set_credentials_openai,
)
from synergyml.utils import extract_json_key
import numpy as np
...
class GPTTunableMixin(BaseTunableMixin):
    ...
    def _tune(self, X, y):
        ...
        filename = f"synergyml_{file_uuid}.jsonl"
