...
_OPENAI_KEY_VAR = "SynergyML_CONFIG_OPENAI_KEY"
_OPENAI_ORG_VAR = "SynergyML_CONFIG_OPENAI_ORG"
_AZURE_API_BASE_VAR = "SynergyML_CONFIG_AZURE_API_BASE"
_AZURE_API_VERSION_VAR = "SynergyML_CONFIG_AZURE_API_VERSION"
_GOOGLE_PROJECT = "GOOGLE_CLOUD_PROJECT"
_GPT_URL_VAR = "SynergyML_CONFIG_GPT_URL"
_GGUF_DOWNLOAD_PATH = "SynergyML_CONFIG_GGUF_DOWNLOAD_PATH"
_GGUF_MAX_GPU_LAYERS = "SynergyML_CONFIG_GGUF_MAX_GPU_LAYERS"
_GGUF_VERBOSE = "SynergyML_CONFIG_GGUF_VERBOSE"


class SynergyMLConfig:
    @staticmethod
    ...
    def get_gguf_download_path() -> str:
        ...
        default_path = os.path.join(os.path.expanduser("~"), ".synergyml", "gguf")
