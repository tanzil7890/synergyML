from synergyml.llm.gpt.mixin import (
...
class GPTClassifier(_TunableClassifier, _SingleLabelMixin):
    def __init__(
        ...
        custom_suffix: Optional[str] = "synergyml",
        ...
        custom_suffix : Optional[str], optional
            custom suffix of the tuned model, used for naming purposes only, by default "synergyml"
