from synergyml.models._base.classifier import (
...
from synergyml.models._base.vectorizer import BaseVectorizer
    ...
    def __init__(
        ...
        **kwargs,
        ...
        memory_index : Optional[IndexConstructor], optional
            custom memory index, for details check `synergyml.memory` submodule, by default None
