...
from synergyml.internal.segmentation_utils import _get_summary_optional_params
...
def display_issues(
    ...
    **kwargs,  # Accepting additional kwargs for plt.show()
    ...
    issues:
      ...
      Same format as output by :py:func:`segmentation.filter.find_label_issues <synergyml.segmentation.filter.find_label_issues>`
      or :py:func:`segmentation.rank.issues_from_scores <synergyml.segmentation.rank.issues_from_scores>`.
    ...
    labels:
      ...
      Refer to documentation for this argument in :py:func:`find_label_issues <synergyml.segmentation.filter.find_label_issues>` for more information.
